...
<html lang="en">
	...
	<head>
		...
		<meta name="description" content="SolTech - Premium Marketing Landing Pages Pack">
		<meta name="keywords" content="HTML5, DSAThemes, Creative, Agency, Digital Business, IT Solutions, Digital Product, Marketinge, SaaS, Startup">	
		<meta name="viewport" content="width=device-width, initial-scale=1">

		<!-- SITE TITLE -->
		<title>SolTech - Premium Marketing Landing Pages Pack</title>
	...
	<body> 
		...
		<div id="page" class="page">
			...
			<header id="header" class="tra-menu navbar-dark white-scroll">
				<div class="header-wrapper">
				    ...
				    <div class="wsmobileheader clearfix">	  	
				    	<span class="smllogo">
				    		<a href="#hero-6"><img src="images/logo-indigo.png" alt="mobile-logo"></a>
				    	</span>
				  	...
				  	<div class="wsmainfull menu clearfix">
	    				<div class="wsmainwp clearfix">
	    					...
	    					<div class="desktoplogo">
	    						<a href="#hero-6" class="logo-black"><img src="images/logo-indigo.png" alt="logo"></a>
	    					</div>


	    					<!-- HEADER WHITE LOGO -->
	    					<div class="desktoplogo">
	    						<a href="#hero-6" class="logo-white"><img src="images/logo-indigo-white.png" alt="logo"></a>
	    					</div>
	      					...
	      					<nav class="wsmenu clearfix">
	        					<ul class="wsmenu-list nav-theme">
							    	...
							    	<li class="nl-simple" aria-haspopup="true">
							    		<a href="features.html" class="h-link">Services</a>
							    	</li>


							    	<!-- SIMPLE NAVIGATION LINK -->
							    	<li class="nl-simple" aria-haspopup="true">
							    		<a href="reviews.html" class="h-link">Customers</a>
							    	</li>


							    	<!-- SIMPLE NAVIGATION LINK -->
							    	<li class="nl-simple" aria-haspopup="true">
							    		<a href="pricing.html" class="h-link">Pricing</a>
							    	</li>


							    	<!-- SIMPLE NAVIGATION LINK -->
							    	<li class="nl-simple" aria-haspopup="true">
							    		<a href="faqs.html" class="h-link">FAQs</a>
							    	</li>
								    ...
								    <!-- GET STARTED BUTTON -->
								    <li class="nl-simple" aria-haspopup="true">
								    	<a href="signup-1.html" class="btn r-06 btn--theme hover--tra-coal last-link">Get Started</a>
								    </li>
				...
				<div class="hero-overlay">
					<div class="container">	
						<div class="row d-flex align-items-center">
							...
							<!-- HERO TEXT -->
							<div class="col-md-6">
								<div class="hero-6-txt wow animate__animated animate__fadeInRight">

									<!-- Title -->
									<h2>The growth engine for your online business</h2>

									<!-- Text -->
									<p class="p-lg">Mauris donec ociis magnis sapien an ipsum sagittis sapien tempor ipsum volute 
										gravida sapien vitae 
									</p>

									<!-- HERO QUICK FORM -->
									<form name="quickform" class="quick-form form-half">
									...
									<p class="p-sm btn-txt ico-15">
										<span class="flaticon-check-1"></span> No credit card needed, free 14-day trial
									</p>
							...
							<div class="col-md-6">	
								<div class="hero-6-img text-center wow animate__animated animate__fadeInLeft">
									<img class="img-fluid" src="images/img-05.png" alt="hero-image">					
								</div>
							</div>	
			...
			<!-- STATISTIC-1
			============================================= -->
			<div id="statistic-1" class="pb-100 statistic-section division">
				<div class="container">
									...
									<div class="statistic-block">	
										...
										<div class="statistic-block-digit text-center">
											<h2 class="h2-md statistic-number">
												<span class="count-element">7</span>.<span class="count-element">8</span><small>k</small>
											</h2>
										</div>
							...
							<div class="col">							
								<div id="sb-1-2" class="animate__animated animate__fadeInUp">
									<div class="statistic-block">		
										...
										<div class="statistic-block-digit text-center">
											<h2 class="h2-md statistic-number">
												<span class="count-element">76</span><small>%</small>
											</h2>
										</div>
							...
							<div class="col">							
								<div id="sb-1-3" class="animate__animated animate__fadeInUp">
									<div class="statistic-block">		
										...
										<!-- Text -->
										<div class="statistic-block-txt">
											<p class="p-md">Sagittis congue augue egestas placerat</p>
										</div>
					...
					<div class="row justify-content-center">	
						<div class="col-md-9">
							<div class="section-title mb-80">	
								...
								<!-- Title -->
								<h2 class="h2-xl">Digital marketing that drives results for your business</h2>
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-6">
									<div class="txt-block right-column wow animate__animated animate__fadeInLeft">
										...
										<!-- Section ID -->	
						 				<span class="section-id">Complete Solutions</span>
							...
							<!-- FEATURE BOX #1 -->
		 					...
		 					<div class="col">
		 						<div class="fbox-7 fb-3 wow animate__animated animate__fadeInUp">
									...
									<!-- Text -->
									<div class="fbox-txt">
										<h6 class="h6-xl">Content Management</h6>
										<p>Egestas luctus augue undo ultrice quisque in lacus cursus feugiat eget ultrice 
			...
			<!-- FEATURES-4
			============================================= -->
			<section id="features-4" class="shape--bg shape--whitesmoke pt-100 features-section division">
				<div class="container">
					<div class="row d-flex align-items-center">
								...
								<div class="row">
				 					...
				 					<div class="col-md-6">
				 						...
				 						<div id="fb-4-1" class="fbox-4 block--shadow r-12 wow animate__animated animate__fadeInRight">
											...
											<!-- Title -->
											<h6 class="h6-lg">Digital Marketing</h6>
				 						...
				 						<div id="fb-4-2" class="fbox-4 block--shadow r-12 wow animate__animated animate__fadeInRight">
											...
											<!-- Title -->
											<h6 class="h6-lg">Data & Analytics</h6>
				 					...
				 					<div class="col-md-6">
				 						...
				 						<div id="fb-4-3" class="fbox-4 block--shadow r-12 wow animate__animated animate__fadeInRight">
											...
											<!-- Title -->
											<h6 class="h6-lg">Dev and Design</h6>
				 						...
				 						<div id="fb-4-4" class="fbox-4 block--shadow r-12 wow animate__animated animate__fadeInRight">
											...
											<!-- Title -->
											<h6 class="h6-lg">Content Strategy</h6>
						...
						<div class="col-md-5 order-first order-md-2">
							<div class="txt-block left-column wow animate__animated animate__fadeInLeft">
								...
								<!-- Title -->	
								<h2>Everything you need to get more leads and sales</h2>

								<!-- Text -->	
								<p>Sodales tempor sapien quaerat ipsum congue and undo laoreet turpis neque auctor turpis vitae
								   dolor luctus placerat magna ligula cursus vitae
								</p>

								<!-- Text -->	
								<p class="mb-0">Tempor sapien sodales quaerat ipsum congue and undo laoreet turpis neque auctor
								   turpis vitae dolor luctus placerat magna ligula cursus vitae egestas varius laoreet suscipit 
								   ipsum placerat magna
								</p>
						...
						<div class="col-md-6 order-last order-md-2">
							<div class="txt-block left-column wow animate__animated animate__fadeInRight">
								...
								<div class="txt-box">
									...
									<!-- Title -->	
									<h5 class="h5-lg">Data-driven digital marketing</h5>
								...
								<div class="txt-box">
									...
									<!-- Title -->	
									<h5 class="h5-lg">Solutions that drives success</h5>
					...
					<div class="row justify-content-center">	
						<div class="col-md-9">
							<div class="section-title mb-70">		
								...
								<!-- Title -->	
								<h2 class="h2-xl">Build a customer-centric marketing strategy</h2>	
							...
							<div class="col-md-6">
								<div class="fbox-10 fb-5 bg--whitesmoke r-16 wow animate__animated animate__fadeInUp">
									...
									<div class="fbox-10-img text-center">
										<img class="img-fluid" src="images/integrations.png" alt="feature-image">
									</div>
							...
							<div class="col-md-6">
								<div class="fbox-10 fb-6 bg--whitesmoke r-16 wow animate__animated animate__fadeInUp">
									...
									<div class="fbox-txt">
										...
										<!-- Title -->	
										<h5 class="h5-lg">Personalized Strategy</h5>
		 							...
		 							<!-- IMAGE -->
									<div class="fbox-10-img text-center">
										<img class="img-fluid" src="images/analytics.png" alt="feature-image">
									</div>
						...
						<div class="section-overlay">
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-6 col-lg-7">
									<div class="bc-2-img left-column wow animate__animated animate__fadeInRight">
										<img class="img-fluid" src="images/progress-right.png" alt="content-image">
									</div>	
								</div>
								...
								<div class="col-md-6 col-lg-5 order-last order-md-2">
									<div class="txt-block right-column wow animate__animated animate__fadeInLeft">
										...
										<ul class="simple-list">
											...
											<li class="list-item">
												<p>Tempor sapien quaerat ociis laoreet ipsum purus and sapien dolor ultrice semper
												   undo aliquam congue purus and pretium
												</p>
											</li>

											<li class="list-item">
												<p class="mb-0">Cursus purus suscipit vitae egestas augue volute placerat undo vitae
												   ultrice sapien 
												</p>
											</li>
										...
										<!-- Link -->	
										<div class="txt-block-tra-link">
											<a href="features.html" class="tra-link ico-20 color--theme">
												Discover More <span class="flaticon-next"></span>
											</a>
										</div>
					...
					<div class="int-1-wrapper">
						<div class="row row-cols-1 row-cols-md-2 row-cols-lg-3">
							...
							<!-- INTEGRATION TOOL #1 -->
		 					<div class="col">
		 						<a href="#">
		 							<div class="int_tool-1 r-12 wow animate__animated animate__fadeInUp">
		 					...
		 					<div class="col">
		 						<a href="#">
		 							<div class="int_tool-1 r-12 wow animate__animated animate__fadeInUp">
			 							...
			 							<div class="tool_logo_wrap">
			 								<div class="tool_logo">
												<img class="img-fluid" src="images/png_icons/zendesk.png" alt="tool-logo">
											</div>
										</div>
		 					...
		 					<div class="col">
		 						<a href="#">
		 							<div class="int_tool-1 r-12 wow animate__animated animate__fadeInUp">
			 							...
			 							<div class="tool_logo_wrap">
			 								<div class="tool_logo">
												<img class="img-fluid" src="images/png_icons/google_analytics.png" alt="tool-logo">
											</div>
										</div>
					...
					<div class="row">
						<div class="col">
							<div class="more-btn text-center mt-30 wow animate__animated animate__fadeInUp">	
								<a href="integrations.html" class="btn r-06 btn--tra-black hover--theme">View Integrations</a>
							</div>	
						</div>
					</div>
								...
								<div class="cbox-6">
									...
									<!-- Icon & Title -->
		 							<div class="cbox-title">
										...
										<h5 class="h5-lg">Control Data Access</h5>
									</div>
								...
								<div class="cbox-6">
									...
									<!-- Icon & Title -->
		 							<div class="cbox-title">
										...
										<h5 class="h5-lg">Realtime Dashboard</h5>
									</div>
								...
								<div class="cbox-6">
									...
									<!-- Icon & Title -->
		 							<div class="cbox-title">
										...
										<h5 class="h5-lg">Real-Time Analytics</h5>
									</div>
									...
									<div class="row">
											...
											<div class="cbox-5 cb-1">
												...
												<!-- Icon & Title -->
					 							<div class="box-title ico-30">
													...
													<h6 class="h6-lg">Smart</h6>
												</div>

												<!-- Text -->
												<p class="p-sm">Sodales sapien quaerat diam blandit purus a placerat turpis diam 
												   cubilia laoreet mauris
												</p>
										...
										<div class="col-md-6">
											<div class="cbox-5 cb-2">
												...
												<!-- Text -->
												<p class="p-sm">Quaerat sodales sapien diam blandit purus a placerat turpis undo 
												   cubilia mauris laoreet
												</p>
						...
						<div class="row d-flex align-items-center">
							...
							<div class="col-lg-6">
								<div class="txt-block left-column wow animate__animated animate__fadeInUp">
									...
									<!-- Button -->
									<a href="reviews.html" class="btn r-06 btn--theme hover--tra-coal">Read All Reviews</a>
			...
			<!-- BRANDS-3
			============================================= -->
			<div id="brands-3" class="py-100 brands-section">
				<div class="container">	
					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-9">
							<div class="brands-title">
								<h6 class="h6-xl">Trusted by companies, big or not-so-big:</h6>
							</div>
						</div>
					</div>
					...
					<div class="brands-3-wrapper">
						<div class="row justify-content-md-center row-cols-3 row-cols-sm-3 row-cols-md-5">


							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-1" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-2" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-3" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-4" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-5" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-6" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-7" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-8" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-9" class="brand-logo">
							...
							<!-- BRAND LOGO IMAGE -->
							<div class="col">
								<div id="brand-3-10" class="brand-logo">
									<a href="#"><img class="img-fluid" src="images/brand-2.png" alt="brand-logo"></a>
								</div>
							</div>
					...
					<div class="row justify-content-center">	
						<div class="col-md-10 col-lg-9">
							<div class="section-title mb-70">
								...
								<!-- Title -->	
								<h2 class="h2-xl">Latest News & Insights</h2>
				 		...
				 		<div class="col">
				 			<div id="bp-1-1" class="blog-post wow animate__animated animate__fadeInUp">
								...
								<div class="blog-post-txt">
									...
									<!-- Short Description -->
									<p>Sagittis congue augue egestas velna integer a purus filis magna suscipit...</p>
							...
							<div class="row d-flex align-items-center">
								...
								<div class="col-md-8 col-lg-7">
									<div class="banner-1-txt">
										...
										<!-- Button -->
										<a href="signup-1.html" class="btn btn-sm r-06 btn--theme hover--theme">Get Srarted</a>
										<a href="pricing.html" class="btn btn-sm r-06 btn--tra-coal hover--coal">View Pricing</a>
			        ...
			        <div class="modal-content">
			            ...
			            <div class="modal-body text-center">
		            		...
		            		<div class="modal-body-img">
		            			<img class="img-fluid" src="images/modal-newsletter.png" alt="modal-image">
		            		</div>
			...
			<!-- FOOTER-2
			============================================= -->
			<footer id="footer-2" class="pt-100 footer">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4">
							<div class="footer-info">
								...
								<!-- Logo -->	
								<img class="footer-logo" src="images/logo-indigo.png" alt="footer-logo">
								
								<!-- Text -->	
								<p>Aliquam nullam tempor sapien gravida donec porta congue ipsum justo velna auctor lacus a suscipit
								   egestas magna aliquam and cubilia augue blandit
								</p>
								...
								<!-- FOOTER LINKS #1 -->
							 	<div class="col-md-3">
							 		<div class="fl-1">
								 		...
								 		<!-- Title -->
								        <h6 class="d-title">About</h6>
									    <h6 class="m-title">About</h6>

									    <!-- Links -->
								     	 <ul class="foo-links clearfix">
											<li><p><a href="about.html">About Us</a></p></li>
											<li><p><a href="team.html">Our Team</a></p></li>
											<li><p><a href="careers.html">Careers</a></p></li>	
											<li><p><a href="#">Press & Media</a></p></li>	
							    ...
							    <!-- FOOTER LINKS #2 -->
							 	<div class="col-md-3">
							 		<div class="fl-2">
									    ...
									    <!-- Links -->
								     	<ul class="foo-links clearfix">
											<li><p><a href="services.html">Core Services</a></p></li>
											<li><p><a href="ntegrations.html">Integrations</a></p></li>				
											<li><p><a href="pricing.html">Pricing Plans</a></p></li>
							 		...
							 		<div class="fl-3">
									    ...
									    <!-- Links -->
								     	<ul class="foo-links clearfix">
											...
											<li><p><a href="blog-listing.html">Site Map</a></p></li>						
										</ul>
							 	...
							 	<div class="col-md-3">
							 		<div class="fl-4">
									    ...
									    <!-- Links -->
								     	 <ul class="foo-links ico-10 clearfix">
											<li><p><a href="#"><span class="flaticon-facebook"></span> Facebook</a></p></li>
											<li><p><a href="#"><span class="flaticon-twitter-1"></span> Twitter</a></p></li>		
											<li><p><a href="#"><span class="flaticon-linkedin-logo"></span> LinkedIn</a></p></li>
											<li><p><a href="#"><span class="flaticon-dribbble"></span> Dribbble</a></p></li>		
										</ul>
					...
					<div class="bottom-footer">
						<div class="row row-cols-1 row-cols-md-2 d-flex align-items-center">
							...
							<!-- FOOTER COPYRIGHT -->
							<div class="col">
								<div class="footer-copyright"><p class="p-sm">&copy; 2024 SolTech. <span>All Rights Reserved</span></p></div>
							</div>
							...
							<div class="col">
								<div class="bottom-secondary-link ico-15 text-end">
									<p class="p-sm"><a href="https://themeforest.net/user/dsathemes/portfolio">Made with 
										<span class="flaticon-heart color--pink"></span> by @DSAThemes</a>
									</p>
								</div>
							</div>
